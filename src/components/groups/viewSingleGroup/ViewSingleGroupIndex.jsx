...
class ViewSingleGroupIndex extends Helper {
  ...
  deleteGroup = () => {
    this.setState({
      ...
      loadingContentDelete: "Loading... Please wait",
    });
    api
  ...
  addParticipant = (event, user) => {
    ...
    this.setState({
      ...
      addParticipantLoadingContent: "Adding...",
    });
  ...
  removeMember = (event, user) => {
    ...
    this.setState({
      ...
      removeMemberLoadingContent: "Removing...",
    });
      ...
      <div className="main">
        ...
        {loadingGroup ? (
          ...
          <div className="sec-padding view-group left-spacing1">
            ...
            <div className="public-video-header">View Group</div>
            <div className="Spacer-10"></div>
            ...
            <div className="row text-center small-padding">
              {groupData.actions.is_edit_group == 1 ? (
                <div className="col-md-4">
                  ...
                  >
                    <i className="fa fa-edit icon"></i> Edit Group
                  </a>
                </div>
              ) : (
                ""
              ...
              {groupData.actions.is_add_remove_group == 1 ? (
                <div className="col-md-4">
                  ...
                  >
                    <i className="fa fa-plus-square icon"></i> Add Participants
                  </a>
                </div>
              ) : (
                ""
...
export default withToastManager(ViewSingleGroupIndex);
